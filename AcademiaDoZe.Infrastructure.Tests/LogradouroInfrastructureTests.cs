...
public class LogradouroInfrastructureTests : TestBase
{
    ...
    {
        var cep = GerarCep();
        var logradouroResult = Logradouro.Criar(0, cep, "Matheus", "Ribeiro", "SQLite", "SC", "Brasil");
    ...
    {
        var cep = GerarCep();
        var logradouro = Logradouro.Criar(0, cep, "Matheus", "Ribeiro", "SQLiteS", "SC", "Brasil").Value!;
        ...
        Assert.Equal("Matheus", inserido.Nome);
